...
function meuMiddleware(requisicao, resposta, proximo){
    console.log();
...
// Rotas do Home
route.get('/', meuMiddleware, homeController.paginaInicial); // colocando a primeira rota GET atraves do metodo Controller.
