...
const homeController = require('./controllers/homeController'); // controller da pagina home
const contatoController = require('./controllers/contatoController'); //controller da pagina contato.
